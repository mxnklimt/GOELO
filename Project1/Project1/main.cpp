...
// Our state
    ...
    while (!done)
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            elonow = players_notclear[12].elo; //myelo
            ...
            float data[] = { 0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 0.7f, 0.8f, 0.9f, 1.0f,1.1f,1.2f,1.3f,1.4f,1.5f,1.6f,1.7f,1.8f,1.9f };
			for (int j = games.size() - 1; j >= 0; j--)
			{
				...
				data[j] = data[j+1]-games[j].elo_change;
			}
            ...
            ImGui::SetNextWindowSize(ImVec2(400, 400), ImGuiCond_Always); // 设置新窗口尺寸

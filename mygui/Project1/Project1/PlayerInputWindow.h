    ...
    void display2(std::vector<ChessGame>& games, std::vector<ChessPlayer>& players_notclear)
    {
		...
		if (ImGui::CollapsingHeader(u8"新对局")) {
			...
			if (ImGui::Button(u8"添加对局")) {
                ...
                players_notclear[0].elo = 1050;
                players_notclear[1].elo = 1100;
                players_notclear[2].elo = 1150;
                players_notclear[3].elo = 1250;
                players_notclear[4].elo = 1300;
                players_notclear[5].elo = 1350;
                players_notclear[6].elo = 1450;
                players_notclear[7].elo = 1500;
                players_notclear[8].elo = 1550;
                players_notclear[9].elo = 1650;
                players_notclear[10].elo = 1700;
                players_notclear[11].elo = 1750;
                players_notclear[12].elo = 1850;
                players_notclear[13].elo = 1900;
                players_notclear[14].elo = 1950;
                players_notclear[15].elo = 2050;
                players_notclear[16].elo = 2100;
                players_notclear[17].elo = 2150;
                players_notclear[18].elo = 2250;
                players_notclear[19].elo = 2300;
                players_notclear[20].elo = 2350;
                players_notclear[21].elo = 2450;
                players_notclear[22].elo = 2500;
                players_notclear[23].elo = 2550;
                ...
                if (number3 == 1)
                {
                    FileManager::saveGameData(games_last, "mygame.txt");
                }
                games_last.clear();
